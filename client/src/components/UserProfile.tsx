...
export const UserProfile: React.FC = () => {
  ...
  const [formData, setFormData] = useState({
      ...
      workingHours: {
        start:  currentUser ?currentUser.workingHours.start : '09:00',
        end:  currentUser ?currentUser.workingHours.end : '17:00',
        daysOfWeek:  currentUser ? currentUser.workingHours.daysOfWeek : [1, 2, 3, 4, 5] // Default to weekdays
      }
              ...
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm text-gray-600">
                    Role: <span className="font-medium capitalize">{currentUser?.role || 'User'}</span>
                  </p>
                  <p className="text-sm text-gray-600">
                ...
                <button
                  type="submit"
                  className={`px-6 py-2 rounded-md transition-colors flex items-center space-x-2 ${saved
